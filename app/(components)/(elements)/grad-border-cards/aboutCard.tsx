...
import GradientCornerBorder from './GradientCornerBorderCard';

interface AboutCardProps {
    card: any;
    index: number;
    section_about_cardsContent: any;
}
...
const AboutCard: React.FC<AboutCardProps> = ({
  ...
  return (
    <div 
    key={index} 
    className={`h-full w-full rounded-lg bg-[rgba(58,58,58,0.1)] relative
