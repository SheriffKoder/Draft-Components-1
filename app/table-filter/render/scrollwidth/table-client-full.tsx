...
export function DemoTableClient() {
  ...
  return (
    <div className="flex flex-col h-[100vh] overflow-hidden">
        ...
        <div className="flex flex-col space-y-4 p-8 pt-6 pb-4 pr-4 min-w-[1200px] h-full">
          

          {/* Table container - take remaining height space no scroll outside */}
          <div className="table_container flex-1 border-sgrey border rounded-[14px] overflow-hidden flex flex-col h-[calc(100vh-200px)]">
