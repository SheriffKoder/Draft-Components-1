...
import InteractiveBarChart from './InteractiveBarChart-v1';

const BarChartContainerV2 = ({
    title,
    value,
    subTitle,
    subTitleExt,
  ...
  datasets: [
    {
      ...
      backgroundColor: [
        // First 10 bars in purple/blue
        ...Array(10).fill('rgba(123, 104, 238, 0.8)'),
        // 11th bar (index 10) in a different color (e.g., red)
        'rgba(255, 99, 132, 0.8)',
        // Next 11 bars in purple/blue
        ...Array(11).fill('rgba(123, 104, 238, 0.8)'),
        // Next 8 bars in gray
...
export default BarChartContainerV2  
