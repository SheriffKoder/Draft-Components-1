...
export const DonutChartCutShadowLarge: React.FC<DonutChartProps> = ({
  currentProfit,
  totalProfit,
  ...
  return (
    <div className="relative w-fit h-full flex items-center justify-center flex-col overflow-visible" style={{ margin: '0px' }}>
