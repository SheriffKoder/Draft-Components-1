...
const MobileNavBar = () => {
  ...
  return (
    ...
    flex flex-row justify-between items-center px-[10%] z-[99] transition-all duration-700 ease'>
        ...
        <Link href="/">
                <Image src="/mainLogo.png" alt="company logo 1" 
                className='absolute left-[1.5rem] top-[1rem] my-auto z-[99] invert' width={25} height={25} ></Image>            
        </Link>
