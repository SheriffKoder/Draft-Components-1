...
const InteractiveBarChart: React.FC<InteractiveBarChartProps> = ({
  ...
  useEffect(() => {
    ...
    const chartData = {
      labels: data.labels || [],
      // CHANGED: to allow the application of category colors.
      datasets: data.datasets.map(dataset => {
        // If dataset already has backgroundColor/borderColor, use those
        // Otherwise, use the props
        const datasetBackgroundColor = dataset.backgroundColor || activeColor;
        const datasetBorderColor = dataset.borderColor || activeBorderColor;
