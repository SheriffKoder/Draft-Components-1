...
const page = () => {
  ...
  useEffect(() => {
    ...
    .to(layer2, {
      opacity: 1,
      y: -100, // Move above first layer
      duration: 0.33,
      ease: "power2.inOut"
    })
    .to(layer3, {
      y: -100, // Move to where second layer will be (preparation for next step)
      duration: 0.33,
      ease: "power2.inOut"
    }, "<")
    .to(text2, {
  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      >
        ...
        <div 
          ref={layer1Ref}
          className="w-64 h-32 bg-white absolute shadow-lg"
          style={{ 
        ...
        <div 
          ref={layer2Ref}
          className="w-64 h-32 bg-gray-100 absolute shadow-xl"
          style={{ 
            transformOrigin: 'center center',
            transform: 'rotateX(10deg)'
          }}
        ...
        <div 
          ref={layer3Ref}
          className="w-64 h-32 bg-gray-200 absolute shadow-2xl"
          style={{ 
            transformOrigin: 'center center',
            transform: 'rotateX(10deg)'
          }}
