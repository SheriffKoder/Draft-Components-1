...
const page = () => {
  ...
  useEffect(() => {
    ...
    // Animation sequence
    // Step 1: Show boxes and move them apart (0% to 33%)
    tl.to([box1, box2], {
      opacity: 1,
      duration: 0.33,
      ease: "power2.out"
    ...
    // Step 2: Rotate and add border radius (33% to 66%)
    .to([box1, box2], {
      rotation: 180,
      borderRadius: "17px",
      duration: 0.33,
    ...
    // Step 3, 4 & 5 Combined: Reverse rotation/border radius, then return to center, then fade out (66% to 100%)
    // Step 3: Reverse rotation and border radius (first third of remaining time)
    .to([box1, box2], {
      rotation: 0,
      borderRadius: "0px",
      duration: 0.11, // One third of 0.33
      ease: "power2.inOut"
    })
    // Step 4: Return to center (second third of remaining time)
    .to([box1, box2], {
      x: 0,
      duration: 0.11, // One third of 0.33
      ease: "power2.inOut"
    })
    // Step 5: Fade out (final third of remaining time)
    .to([box1, box2], {
      opacity: 0,
      duration: 0.11, // One third of 0.33
      ease: "power2.inOut"
